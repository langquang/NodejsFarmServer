...
var GameData = function (userId, userName, gold, energy, lastEnergy, exp) {
    this.initialize(userId, userName, gold, energy, lastEnergy, exp);
};
...
//================================ Constructor =============================
GameData.prototype.initialize = function (userId, userName, gold, energy, lastEnergy, exp) {
    this.userId = userId;
